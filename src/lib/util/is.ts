...
/** @const @param _x */
export function bool(_x: unknown): _x is boolean {
  return _x === true || _x === false;
}

/** @const @param _x */
export function string(_x: unknown): _x is string {
  return typeof _x === "string" || _x instanceof String;
}

/** @const @param _x */
export function num(_x: unknown): _x is number {
...
/** @const @param _x */
export function error(_x: unknown): _x is Error {
  return _x instanceof Error;
}

/** @const @param _x */
export function func(_x: unknown): _x is Function {
  return typeof _x === "function";
}

/** @const @param _x */
export function array(_x: unknown): _x is unknown[] {
  return Array.isArray(_x);
}

/** @const @param _x */
export function stringArray(_x: unknown): _x is string[] {
  return array(_x) && (_x as unknown[]).every((_y) => string(_y));
}

/** @const @param _x */
export function typedArray(_x: unknown): _x is TypedArray {
 ...
 */
export function thenable(_x: unknown): _x is Thenable<unknown> {
  return !!_x && (typeof _x === "object" || func(_x)) && func((_x as any).then);
}
